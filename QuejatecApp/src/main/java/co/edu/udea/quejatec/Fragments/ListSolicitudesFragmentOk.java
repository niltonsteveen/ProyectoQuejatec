...
public class ListSolicitudesFragmentOk extends Fragment {
    ...
    public ListSolicitudesFragmentOk() {
        // Required empty public constructor
    }

    public static ListSolicitudesFragmentOk newInstance(Bundle arguments){
        ListSolicitudesFragmentOk f= new ListSolicitudesFragmentOk();
        if(arguments != null){
